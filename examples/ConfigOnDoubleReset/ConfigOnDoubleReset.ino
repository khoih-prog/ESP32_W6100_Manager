...
#if !( defined(ESP32) )
  #error This code is intended to run on the (ESP32 + LwIP W6100) platform! Please check your Tools->Board setting.
#endif
...
void setup()
{
  ...
  ESP32_W6100_Manager ESP32_W6100_manager("ConfigOnDoubleReset");
