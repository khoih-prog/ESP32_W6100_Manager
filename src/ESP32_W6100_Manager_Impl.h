/****************************************************************************************************************************
  ESP32_W6100_Manager_Impl.h

  For Ethernet shields using ESP32_W6100 (ESP32 + LwIP W6100)
  ...
  Built by Khoi Hoang https://github.com/khoih-prog/ESP32_W6100_Manager
  ...
  ------- -----------  ---------- -----------
  1.0.0   K Hoang     14/01/2023 Initial coding for ESP32_W6100 (ESP32 + LwIP W6100)
 *****************************************************************************************************************************/

#pragma once

#ifndef ESP32_W6100_Manager_Impl_h
#define ESP32_W6100_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESP32_EMParameter** ESP32_W6100_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int ESP32_W6100_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* ESP32_W6100_Manager::getRFC952_hostname(const char* iHostname)
{
...
ESP32_W6100_Manager::ESP32_W6100_Manager(const char *iHostname)
{
...
#if USE_DYNAMIC_PARAMS
  bool ESP32_W6100_Manager::addParameter(ESP32_EMParameter *p)
#else
  void ESP32_W6100_Manager::addParameter(ESP32_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void ESP32_W6100_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&ESP32_W6100_Manager::handleRoot,         this));
  server->on("/eth",      std::bind(&ESP32_W6100_Manager::handleETH,          this));
  server->on("/ethsave",  std::bind(&ESP32_W6100_Manager::handleETHSave,      this));
  server->on("/close",    std::bind(&ESP32_W6100_Manager::handleServerClose,  this));
  server->on("/i",        std::bind(&ESP32_W6100_Manager::handleInfo,         this));
  server->on("/r",        std::bind(&ESP32_W6100_Manager::handleReset,        this));
  server->on("/state",    std::bind(&ESP32_W6100_Manager::handleState,        this));
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&ESP32_W6100_Manager::handleRoot,         this));
  server->onNotFound(     std::bind(&ESP32_W6100_Manager::handleNotFound,     this));
...
bool ESP32_W6100_Manager::startConfigPortal()
{
  connect = false;
...
void ESP32_W6100_Manager::setTimeout(const unsigned long& seconds)
{
...
void ESP32_W6100_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void ESP32_W6100_Manager::setConnectTimeout(const unsigned long& seconds)
{
  _connectTimeout = seconds * 1000;
}

void ESP32_W6100_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void ESP32_W6100_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void ESP32_W6100_Manager::reportStatus(String& page)
{
...
void ESP32_W6100_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void ESP32_W6100_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void ESP32_W6100_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void ESP32_W6100_Manager::handleRoot()
{
...
void ESP32_W6100_Manager::handleETH()
{
...
void ESP32_W6100_Manager::handleETHSave()
{
  LOGDEBUG(F("ETH save"));
...
void ESP32_W6100_Manager::handleServerClose()
{
...
void ESP32_W6100_Manager::handleInfo()
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about ESP32_W6100_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/ESP32_W6100_Manager\">https://github.com/khoih-prog/ESP32_W6100_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void ESP32_W6100_Manager::handleState()
{
...
void ESP32_W6100_Manager::handleReset()
{
  LOGDEBUG(F("Reset"));
...
void ESP32_W6100_Manager::handleNotFound()
{
  if (captivePortal())
  {
...
*/
bool ESP32_W6100_Manager::captivePortal()
{
...
void ESP32_W6100_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void ESP32_W6100_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool ESP32_W6100_Manager::isIp(const String& str)
{
...
// IP to String
String ESP32_W6100_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // ESP32_W6100_Manager_Impl_h
